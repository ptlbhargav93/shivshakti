class CustomerBillsController < ApplicationController
  ...
  def customer_bill_params
    params.require(:customer_bill).permit(:invoice_number, :lr_number, :invoice_date, :lr_date, :customer_id, :cgst, :sgst, :total_amount, :creator_id, :updater_id, customer_bill_products_attributes: [:id, :vehical_number, :ref_invoice_number, :from, :to, :quantity, :rate, :_destroy])
  end
